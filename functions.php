...
function weight_update($vtrain,$w1,$w2,$w3,$w4,$w5,$w6,$w7,$w8,$w9,$w10)
{
...
mysql_select_db(MYSQL_DB, $db) or die(mysql_error($db));
   ...
   $sql="UPDATE weights SET w1='$w1',w2='$w2',w3='$w3',w4='$w4',w5='$w5',w6='$w6',w7='$w7',w8='$w8',w9='$w9',w10='$w10' where id='USERFIRST'";
    $sql=mysql_query($sql,$db) or die(mysql_error($db)); 
...
function weight_update_cpu1($vtrain,$w1c,$w2c,$w3c,$w4c,$w5c,$w6c,$w7c,$w8c,$w9c,$w10c)
{
...
mysql_select_db(MYSQL_DB, $db) or die(mysql_error($db));
   ...
   $sql="UPDATE weights SET w1='$w1c',w2='$w2c',w3='$w3c',w4='$w4c',w5='$w5c',w6='$w6c',w7='$w7c',w8='$w8c',w9='$w9c',w10='$w10c' where id='CPUFIRST'";
    $sql=mysql_query($sql,$db) or die(mysql_error($db)); 
